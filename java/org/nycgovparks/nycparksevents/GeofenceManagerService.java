 ...
 */
public class GeofenceManagerService extends IntentService implements
        ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status>{

    protected static final String TAG = "GeofenceManagerService";
    ...
    private ArrayList<ParkEvent> events;

    public GeofenceManagerService() {
        super(TAG);
    ...
    public void populateGeofenceList() {
        for (ParkEvent pe: events) {
            ...
            Date peDate = null;
            try {
                peDate = formatter.parse(pe.enddate);
